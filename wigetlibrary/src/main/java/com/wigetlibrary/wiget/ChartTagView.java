...
public class ChartTagView extends View {
    ...
    private float valuePadding = 15F;
    private float labelPadding = 5F;
    private float linePadding = 10F;
...
//        postInvalidate();
    ...
    public void init(Context context,AttributeSet attributeSet){
        ...
        if (attributeSet != null){
            ...
            labelSize =  array.getDimension(R.styleable.ChartTagView_chartLabelSize, convertDp(mContext,50.0F));
            valueSize =  array.getDimension(R.styleable.ChartTagView_chartValueSize,convertDp(mContext,50.0F));
            labelPadding = array.getDimension(R.styleable.ChartTagView_chartLabelPadding,convertDp(mContext,2.0F));
            valuePadding = array.getDimension(R.styleable.ChartTagView_chartValuePadding,convertDp(mContext,30.0F));
            linePadding = array.getDimension(R.styleable.ChartTagView_chartLinePadding,convertDp(mContext,20.0F));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float valueHeight =convertDp(mContext,50.0F) ;
...
//                float totalHeight = (lines + 1)* lineHeight;
    ...
    public float convertDp(Context context, float px) {
        final float scale = context.getResources().getDisplayMetrics().density;
        float result = (float) ((px / 3.0) * scale);
        return result;
    }
}
